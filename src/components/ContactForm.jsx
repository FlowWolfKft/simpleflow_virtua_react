...
export default function ContactForm() {
  ...
  const submit = (event) => {
    ...
    if (!form.name.trim() || !form.email.trim() || !form.gdpr) {
      setStatus('Kérlek, töltsd ki a nevet és az e-mail címet, majd fogadd el az adatkezelési tájékoztatót.')
      return
    }
  ...
  return (
    <form className="contact-form" onSubmit={submit} noValidate>
      ...
      <label>Üzenet<textarea name="message" value={form.message} onChange={update} rows="5" /></label>
